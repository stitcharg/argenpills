...
import { DateInput, TextInput, ImageInput, ImageField, required } from 'react-admin';
	...
	return (
		<Create {...props} title="Agregar Pastilla" onSuccess={onSuccess}>
			<SimpleForm initialValues={defaultValues}>
				...
				{//<TextInput source="image" fullWidth={true} label="URL de la foto de la imagen" />
				}
				...
				{//<TextInput source="lab_image" fullWidth={true} label="URL de la foto del test" />
				}
